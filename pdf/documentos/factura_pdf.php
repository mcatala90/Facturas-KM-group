<?php
	...
	$sql=mysqli_query($con, "select LAST_INSERT_ID(numero_factura) as last, LAST_INSERT_ID(id_factura) as last_id from facturas order by id_factura desc limit 0,1 ");
	$rw=mysqli_fetch_array($sql);
	$numero_factura=$rw['last']+1;	
	$last_id=$rw['last_id']+1;	
