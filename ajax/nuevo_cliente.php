<?php
	...
	if (empty($_POST['nombre'])) {
		...
		$sql="INSERT INTO clientes (nombre_cliente, nombre_comercial_cliente,  telefono_cliente, email_cliente, direccion_cliente, cp_cliente, poblacion_cliente, provincia_cliente, status_cliente, date_added) VALUES ('$nombre','$nombre_comercial','$telefono','$email','$direccion','$cp','$poblacion','$provincia','$estado','$date_added')";
