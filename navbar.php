...
<nav class="navbar navbar-default ">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#">Gestión Islatec</a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
       ...
       <li class="<?php echo $active_proformas;?>"><a href="proformas.php"><i class='glyphicon glyphicon-list-alt'></i> Proformas </a></li>
        <li class="<?php echo $active_presupuestos;?>"><a href="presupuestos.php"><i class='glyphicon glyphicon-list-alt'></i> Presupuestos </a></li>
