  ...
  <body>
	...
	<div class="panel panel-info">
		...
		?>
			<form  class="form-horizontal" role="form" id="datos_factura">
				<div class="form-group row">
				  ...
				  <button type="button" style="padding:4px;" class="btn btn-default" data-toggle="modal" data-target="#nuevoCliente">
						<b>Agregar</b> <span class="glyphicon glyphicon-user"></span> 
						</button>
				  </div>
				...
				<div class="col-md-12">
                    ...
                    <button type="submit" class="btn btn-default">
						  <span class="glyphicon glyphicon-refresh"></span> Guardar Factura
						</button>
			...
			<br>
			<div class="col-md-11">
			<button id="send_form" class="btn btn-primary pull-right">
						  <span class="glyphicon glyphicon-save"></span> Guardar Factura
						</button>
						</div>
