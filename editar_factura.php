  ...
  <body>
	...
	<div class="panel panel-info">
		<div class="panel-heading">
			<h4><i class='glyphicon glyphicon-edit'></i> Editar Factura <span id="numero_factura"><?php echo $numero_factura ?></span></h4>
		</div>
		...
		<?php 
			...
			include("modal/registro_partidas.php");
		?>
			<form class="form-horizontal" role="form" id="datos_factura">
								...
								<select class="form-control input-sm" id="nombre_cliente" name="id_cliente">
									<?php
										...
										while ($rw=mysqli_fetch_array($sql_cliente)){
											...
											if ($id_cliente==$rw_factura['id_cliente']){
												$selected="selected";
											} else {
												$selected="";
											}
				...
				<div class="col-md-12">
					<div class="pull-right">
						...
						<button type="button" class="btn btn-default" data-toggle="modal" data-target="#nuevaPartida">
